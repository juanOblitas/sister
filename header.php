    ...
    <div id="page" class="hfeed site">
        <header id="masthead" class="site-header header header-one" role="banner">
                        ...
                        <div class="wrapper">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="topbar-text">
                                    <p><?php bloginfo('description'); ?></p><!-- Esta es la descripción del sitio -->
                                    <?php
            ...
            <div class="header-bottom">
                <div class="container">
                    <div class="row border-box ml-and-mr">
                        <!-- original <div class="col-lg-3 col-sm-3"> -->
                            <div class="col-xs-3 logo-responsive mt-3 mb-3 width-logo-movil"><!-- jc -->
                                <div class="site-branding width-logo">
                                    <?php
                                    the_custom_logo();
                                    ?>
                            ...
                            <div class="col-xs-9 menu-ul mt-3 mb-3 width-menu logo-menu"><!-- jc -->
                                <nav id="site-navigation" class="navbar navbar-default main-navigation height-box height-sub-menu">
                                    ...
                                    <!-- original <div class="navbar-header"> -->
                                        ...
                                        <div class="collapse navbar-collapse pr-menu margin-right-sub-menu" id="bs-example-navbar-collapse-1">
                                         ...
                                         $defaults = array(
                                            ...
                                            'menu_class'        => 'nav navbar-nav navbar-right primary-menu text-right inline-jc',
